...
<form id="forma" action="cierraDeFalla.php" method="POST">
  <div class="container">
<div id="forma">
  <div class="form-row col-md-3">
     <div class="form-group">
         <label for="selFalla1" id="tipoFalla">Id Avería</label>
         <input id="buscar" name="id" type="search" placeholder="Buscar aquí..." autofocus onkeypress="return soloNum(event)">
     </div>
   
 <div class="form-group">
  <label for="sel2">Pendiente</label>
  <select class="form-control" id="selTrab" name="cancelacion">
    <option>Si</option>
    <option>No</option>
  </select>
</div>
<div class="form-group">
  <label for="calfecha">Fecha cierre:</label>
<input type="date" class="form-control" id="fechaOcu" name="fecha_reporte" placeholder="Fecha de Reparacion" required="required" >
</div>
